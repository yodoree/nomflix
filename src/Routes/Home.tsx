...
function Home() {
  ...
  const clickedMovie =
    bigMovieMatch?.params.id && data?.results.find((movie) => movie.id === Number(bigMovieMatch.params.id));
  return (
    <Wrapper>
      {isLoading ? (
                  ...
                  {clickedMovie && (
                    <>
                      ...
                      <button type="button" onClick={onOverlayClick}>
                        <svg fill="black" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
